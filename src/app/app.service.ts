  ...
  posts: Post[] = [
    {
      ...
      snippet: "Transforming raw data into actionable insights using <strong>Python, SQL, and Excel</strong> to drive strategic decision-making and enhance business performance across various industries.",
